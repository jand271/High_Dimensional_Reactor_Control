...
class HeatExchangerMPCController(object):
    def __init__(self, fem_model, initial_temperature, horizon=10, max_removal_power_density=1):
        ...
        self.solver = CFTOCSolver(A, B, f, T0, T0, horizon, umax=max_removal_power_density)
