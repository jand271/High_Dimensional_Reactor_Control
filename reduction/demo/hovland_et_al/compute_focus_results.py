...
if __name__ == "__main__":
    ...
    reduction.save_reduction_basis("focused/carlberg_focused_on_1_and_6.mat", use_obj_str=False)

    C = np.zeros((6, 6))  # np.eye(6)

    reduction = Carlberg(X, rank, C)

    reduction.save_reduction_basis("focused/carlberg_none.mat", use_obj_str=False)
